use crate::api::patterns::Pattern;
use crate::api::patterns::Pattern::*;
use crate::api::settings::Settings;
use std::sync::Once;
use ta_lib_sys::RetCode;
use ta_lib_sys::{CDL3BLACKCROWS, CDL3WHITESOLDIERS, CDLDARKCLOUDCOVER, CDLDOJI, CDLDRAGONFLYDOJI, CDLENGULFING, CDLEVENINGSTAR, CDLGRAVESTONEDOJI, CDLHAMMER, CDLHANGINGMAN, CDLHARAMI, CDLHARAMICROSS, CDLINVERTEDHAMMER, CDLKICKING, CDLLONGLINE, CDLMARUBOZU, CDLMORNINGSTAR, CDLPIERCING, CDLSHOOTINGSTAR, CDLSHORTLINE, CDLSPINNINGTOP};
